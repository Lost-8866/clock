...
void I2C1_Init(void)
{
	...
	// 【关键】将 I2C1 重映射到 PB8/PB9
    GPIO_PinRemapConfig(GPIO_Remap_I2C1, ENABLE);
	
	
	GPIO_InitStructure.GPIO_Pin=GPIO_Pin_8|GPIO_Pin_9;//设置GPIO的管脚
...
void I2C1_Write_Byte(u8 address,u8 data)
{
	...
	I2C_Send7bitAddress(I2C1,WriteAddress,I2C_Direction_Transmitter);//发送I2C器件地址
...
u8 I2C1_Read_Data(u8 read_addr)
{
	...
	while(!I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_MODE_SELECT));//stm32设置为主模式完毕
	I2C_Send7bitAddress(I2C1,WriteAddress,I2C_Direction_Receiver);//发送I2C器件地址
